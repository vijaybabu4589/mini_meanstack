...
console.log('server started');
	...
	db.collection('myname').updateOne({_id:parseInt(req.param('value'),10)},qstring1,(err,result)=>{
	if (err) return console.log(err)

	console.log(req.param('value'));//get request
	console.log(req.body.value);//post request
	res.end();
